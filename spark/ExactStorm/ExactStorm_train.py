...
tim= time.time()
exactstorm = ExactStorm(window_size = 4500)

exactstorm = exactstorm.fit(principal_components.to_numpy())
...
with open('./exactstorm.pickle', 'wb') as f:
    pickle.dump(exactstorm, f)
